...
var (
	...
	authorsFileHeader = "# This is the official list of go-alternative authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-alternative Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-alternative"
	}
	if startOfSentence {
		return "The go-alternative library"
	}
	return "the go-alternative library"
}
