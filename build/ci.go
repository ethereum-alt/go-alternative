...
import (
	...
	"github.com/ethereum-alt/go-alternative/internal/build"
)
...
func doInstall(cmdline []string) {
	...
	if runtime.Version() < "go1.7" && !strings.Contains(runtime.Version(), "devel") {
		...
		log.Println("go-alternative requires at least Go version 1.7 and cannot")
...
type debMetadata struct {
	...
	// go-alternative version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ethereum-alt/go-alternative/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/ethereum-alt/go-alternative/mobile")
