...
//
// Detailed usage document and tutorial available on the go-alternative Wiki page:
// https://github.com/ethereum-alt/go-alternative/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
import (
	...
	"github.com/ethereum-alt/go-alternative/accounts/abi"
